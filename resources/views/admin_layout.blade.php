			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-menufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Menufacture</span></a></li>
						<li><a href="{{URL::to('/add-menufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Menufacture</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/all-slider')}}"><i class="icon-file-alt"></i><span class="hSlideridden-tablet"> All Slider</span></a></li>

							</ul>
						</li>

						<li><a href="chart.html"><i class="icon-list-alt"></i>{{URL::to('/add-product')}}<span class="hidden-tablet"> Social Link</span></a></li>
